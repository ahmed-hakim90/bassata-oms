-- Platform administration: super-admin console, company invites, suspension,
-- support audit, and approximate tenant data-size metrics.
...
BEGIN
  ...
  SELECT count(*) INTO v_expense_count
    ...
    WHERE s.org_id = p_org_id;
  SELECT count(*) INTO v_purchase_count FROM purchase_invoices WHERE org_id = p_org_id;

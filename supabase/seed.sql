...
INSERT INTO product_variants (
  id, product_id, name, sku, barcode, price_delta, price, image_url,
  is_active, variant_kind, quantity_value, quantity_unit, price_mode, fixed_price
) VALUES
  ('00000000-0000-4000-8000-000000000751', '00000000-0000-4000-8000-000000000701', 'صغير', 'HOT-TEA-001-S', 'EGMENU0001-S', 0, 15.00, NULL, true, 'standard', NULL, NULL, 'fixed_price', 15.00),
  ('00000000-0000-4000-8000-000000000752', '00000000-0000-4000-8000-000000000701', 'كبير', 'HOT-TEA-001-L', 'EGMENU0001-L', 0, 22.00, NULL, true, 'standard', NULL, NULL, 'fixed_price', 22.00),
  ('00000000-0000-4000-8000-000000000753', '00000000-0000-4000-8000-000000000705', 'صغير', 'HOT-COF-003-S', 'EGMENU0005-S', 0, 45.00, NULL, true, 'standard', NULL, NULL, 'fixed_price', 45.00),
  ('00000000-0000-4000-8000-000000000754', '00000000-0000-4000-8000-000000000705', 'وسط', 'HOT-COF-003-M', 'EGMENU0005-M', 0, 55.00, NULL, true, 'standard', NULL, NULL, 'fixed_price', 55.00),
  ('00000000-0000-4000-8000-000000000755', '00000000-0000-4000-8000-000000000705', 'كبير', 'HOT-COF-003-L', 'EGMENU0005-L', 0, 70.00, NULL, true, 'standard', NULL, NULL, 'fixed_price', 70.00)
ON CONFLICT (id) DO UPDATE
SET name = EXCLUDED.name,
    sku = EXCLUDED.sku,
    barcode = EXCLUDED.barcode,
...
INSERT INTO product_recipes (id, org_id, product_id, variant_id) VALUES
  ('00000000-0000-4000-8000-000000000851', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000701', '00000000-0000-4000-8000-000000000751'),
  ('00000000-0000-4000-8000-000000000852', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000701', '00000000-0000-4000-8000-000000000752'),
  ('00000000-0000-4000-8000-000000000853', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000705', '00000000-0000-4000-8000-000000000753'),
  ('00000000-0000-4000-8000-000000000854', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000705', '00000000-0000-4000-8000-000000000754'),
  ('00000000-0000-4000-8000-000000000855', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000705', '00000000-0000-4000-8000-000000000755')
ON CONFLICT DO NOTHING;
...
INSERT INTO product_recipe_lines (recipe_id, ingredient_product_id, quantity, unit, sort_order) VALUES
  ('00000000-0000-4000-8000-000000000851', '00000000-0000-4000-8000-000000000603', 5, 'gram', 0),
  ('00000000-0000-4000-8000-000000000851', '00000000-0000-4000-8000-000000000604', 10, 'gram', 1),
  ('00000000-0000-4000-8000-000000000851', '00000000-0000-4000-8000-000000000606', 200, 'ml', 2),
  ('00000000-0000-4000-8000-000000000851', '00000000-0000-4000-8000-000000000617', 1, 'piece', 3),
  ('00000000-0000-4000-8000-000000000852', '00000000-0000-4000-8000-000000000603', 8, 'gram', 0),
  ('00000000-0000-4000-8000-000000000852', '00000000-0000-4000-8000-000000000604', 15, 'gram', 1),
  ('00000000-0000-4000-8000-000000000852', '00000000-0000-4000-8000-000000000606', 300, 'ml', 2),
  ('00000000-0000-4000-8000-000000000852', '00000000-0000-4000-8000-000000000617', 1, 'piece', 3),
  ('00000000-0000-4000-8000-000000000853', '00000000-0000-4000-8000-000000000601', 7, 'gram', 0),
  ('00000000-0000-4000-8000-000000000853', '00000000-0000-4000-8000-000000000605', 140, 'ml', 1),
  ('00000000-0000-4000-8000-000000000853', '00000000-0000-4000-8000-000000000617', 1, 'piece', 2),
  ('00000000-0000-4000-8000-000000000854', '00000000-0000-4000-8000-000000000601', 8, 'gram', 0),
  ('00000000-0000-4000-8000-000000000854', '00000000-0000-4000-8000-000000000605', 180, 'ml', 1),
  ('00000000-0000-4000-8000-000000000854', '00000000-0000-4000-8000-000000000617', 1, 'piece', 2),
  ('00000000-0000-4000-8000-000000000855', '00000000-0000-4000-8000-000000000601', 10, 'gram', 0),
  ('00000000-0000-4000-8000-000000000855', '00000000-0000-4000-8000-000000000605', 240, 'ml', 1),
  ('00000000-0000-4000-8000-000000000855', '00000000-0000-4000-8000-000000000617', 1, 'piece', 2)
ON CONFLICT (recipe_id, ingredient_product_id) DO UPDATE
